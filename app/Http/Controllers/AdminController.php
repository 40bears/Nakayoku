...
class AdminController extends Controller
{
    ...
    public function paymentCompleteNotification()
    {
        ...
        Notification::send($user, new GeneralNotification('A payment completed by user. Please click to approve it', 'https://cii.40bears.com/admin/transactions-management'));
