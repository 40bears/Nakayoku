            ...
            <div class="row">
                ...
                {{-- <div class="col-md-3 col-sm-12 pleft">
                    <div id="guideleftmenu">
                        ...
                        <h5 class="border-nav pb-3 mb-0 mt-5">{{$category->name}}</h5>
                        <ul class="ps-0 left-menu">
                            @foreach($category->pages as $page)
                            @if($page->status == 'PUBLISHED')
                            <a href="{{ route('view-page', [ 'category' => $category->name, 'page' => $page->title ] ) }}">
                                <li class="border-nav ps-3 py-3 {{ $page->title == $currentPage->title ? 'current-page' : '' }}">
                ...
                <div class="col-md-12 col-sm-12 ps-5 request-pad">
                    ...
                    <div class="d-flex flex-column align-items-center pt-5 justify-content-center pe-5 p-right">
                        <p class="terms-head mb-0 pb-4 align-self-start">Pattern of profile</p>
                        <p class="about-p">
