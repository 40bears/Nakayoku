...
<body>
    ...
    <div class="container-fluid px-0 bg-lgreen">
        <div class="container pb-2 padt-6">
        ...
        <div class="container pmypage user-guide">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 ps-5 common-space">
                    <h3 class="pb-5 signup-h3 text-center">User Guide</h3>
                    ...
                    <div>
                        <h3 class="py-5 border-0 lh-base text-center">Please click one of the links on the left to check Pages</h3>
                    </div>
                </div>
                <!-- Right side ends -->
            </div>
