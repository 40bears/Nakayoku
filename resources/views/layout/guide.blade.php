...
<body>
    ...
    <!-- Fixed sell button starts -->
    <div id="fixedsellbutton">
        <div class="side-fix display">
            <a href="{{ route('add-product') }}">
                <img src="{{ url('assets/images/sell-fixed.png') }}" alt="button" loading="lazy" class="img-fluid" />
            </a>
        </div>
    </div>
    <!-- Fixed sell button ends -->
        ...
        <div class="d-flex justify-content-around align-items-center mt-1">
            <a href="/">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <img src="{{ url('assets/images/top-icon.svg') }}" class="img-fluid" alt="Character" />
                    <p class="bottom-menu">Top</p>
                </div>
            </a>
            <a href="{{route('add-product')}}">
                <div class="d-flex flex-column align-items-center  justify-content-center">
                    <img src="{{ url('assets/images/sell-icon.svg') }}" class="img-fluid pt-1" alt="Character" />
                    <p class="bottom-menu">Sell</p>
                </div>
            </a>
            <a href="{{ route('notifications') }}">
                <div class="d-flex flex-column align-items-center  justify-content-center">
                    <img src="{{ url('assets/images/bell-icon.svg') }}" class="img-fluid" alt="Character" />
                    <p class="bottom-menu">Notification</p>
                </div>
            </a>
            <a href="#" class="bottom-a">
                <div class="d-flex flex-column align-items-center  justify-content-center">
                    <img src="{{ url('assets/images/menu-icon.svg') }}" class="img-fluid" alt="Character" />
        ...
        <ul class="dropdown-content">
            <li>
                ...
                <a href="{{ route('profile-page', ['id' => Auth::id()] ) }}" class="p-0">
                    <div class="d-flex justify-content-between align-items-center margin-a">
                        <div class="d-flex py-3">
                            @if(Auth::user() && Auth::user()->profile_picture != null)
                            <img src="{{ url('storage/uploads/' . Auth::user()->profile_picture) }}" class="align-self-center img-fluid dropdown-profile-img-w me-2" alt="games" />
                            @else
            ...
            <li>
                <a href="{{ route('currently-on-display') }}">
                    <div class="d-flex justify-content-between mx-3">
                        Currently on display
                        <img src="{{ url('assets/images/goback-mark.svg') }}" class="img-fluid rotate" alt="goback" />
                    </div>
            ...
            @if(Auth::user())
            <li>
                <a class="ms-3 green" href="{{ route('logout') }}">Sign out</a>
            </li>
            @else
            <li>
                <a class="ms-3 green" href="{{ route('login') }}">Sign in</a>
            </li>
            @endif
        </ul>
    </div>
