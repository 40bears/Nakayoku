@extends('layout.user')
@section('title', 'Sales and Deposits | GLOBAL CARPATICA SL')
...
<div class="col-md-9 col-sm-12 ps-5 request-pad padt-5">
    ...
    <br><br>
    <h3 class="pb-5 border-0 signin-h3 text-center">There are no sales till date.</h3>
    @else
    <div class="row py-4">
    @foreach($transactions as $transaction)
    <div class="col-lg-4 col-md-6 col-sm-12 sp-mb mb-4">
        <div class="white-box">
